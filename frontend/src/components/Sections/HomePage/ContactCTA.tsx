        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#3b82f6] via-[#2563EB] to-[#1e40af]"></div>
          ...
          <div className="relative z-10 text-center py-8 md:py-10 lg:py-12 xl:py-14 2xl:py-16 px-5 md:px-8 lg:px-10 xl:px-12">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-5 mb-6 md:mb-8 lg:mb-10">
              <button
                className="group bg-white text-[#2563EB] px-5 md:px-6 lg:px-8 xl:px-10 py-2.5 md:py-3 lg:py-4 xl:py-5 rounded-full text-[12px] md:text-[13px] lg:text-[14px] xl:text-[16px] font-bold shadow-2xl shadow-blue-900/40 hover:shadow-3xl hover:-translate-y-1 transition-all inline-flex items-center gap-2 md:gap-3 cursor-not-allowed opacity-90"
              >
