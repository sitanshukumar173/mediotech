  ...
  return (
    <>
      ...
      <section className="hero-section relative bg-gradient-to-br from-gray-50 via-white to-blue-50/30 overflow-hidden pt-6 lg:pt-0">
        ...
        <div className="hero-container px-4 sm-mobile:px-5 md:px-8 lg:px-8 xl:px-14 2xl:px-16 max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto py-10 sm-mobile:py-12 md:py-8 lg:py-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-8 sm-mobile:gap-10 md:gap-6 lg:gap-2 items-stretch min-h-screen md:min-h-screen lg:min-h-screen">
            
            {/* Left Content */}
            <div className="left-content lg:col-span-5 space-y-8 sm-mobile:space-y-10 md:space-y-12 lg:space-y-10 py-4 sm-mobile:py-6 md:py-4 lg:py-12 order-1 md:order-1 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left justify-center">
              {/* Badge - Enhanced */}
              ...
              {/* Headline - Enhanced */}
              <div className="space-y-3 sm-mobile:space-y-4 md:space-y-4 lg:space-y-2 w-full flex flex-col items-center lg:items-start">
                <h1 className="leading-[0.9] md:leading-[0.9] lg:leading-[0.92] font-bold text-gray-900 tracking-tight text-center lg:text-left" style={{ fontSize: 'clamp(2.5rem, 6vw, 3.5rem)' }}>
                  Advanced
                  <br />
                ...
                <p className="text-gray-600 leading-[1.75] md:leading-[1.7] lg:leading-[1.5] max-w-[280px] sm-mobile:max-w-[320px] sm-tablet:max-w-[440px] md:max-w-[580px] lg:max-w-[420px] text-center lg:text-left mx-auto lg:mx-0" style={{ fontSize: 'clamp(0.8rem, 2.5vw, 1rem)' }}>
              ...
              <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 md:gap-4 lg:gap-3 w-full md:w-auto md:justify-center lg:justify-start">
                <button className="group inline-flex items-center justify-center gap-2 sm-mobile:gap-3 md:gap-3.5 lg:gap-3 bg-gradient-to-r from-[#2563EB] to-[#1d4ed8] text-white pl-5 sm-mobile:pl-7 md:pl-7 lg:pl-6 pr-1.5 sm-mobile:pr-2.5 md:pr-2.5 lg:pr-2 py-2.5 sm-mobile:py-3.5 md:py-4 lg:py-3 rounded-full hover:shadow-2xl hover:shadow-blue-400/40 hover:-translate-y-1 transition-all shadow-xl">
              ...
              <div className="relative bg-white/50 backdrop-blur-xl rounded-[16px] sm-mobile:rounded-[18px] md:rounded-[24px] lg:rounded-[20px] px-3 sm-mobile:px-4 md:px-6 lg:px-5 py-2.5 sm-mobile:py-3.5 md:py-5 lg:py-4 shadow-lg hover:shadow-xl border border-white/30 w-full max-w-xs sm-mobile:max-w-md md:max-w-lg lg:max-w-[420px] mx-auto lg:mx-0 transition-all duration-300 overflow-hidden group">
                ...
                <div className="relative z-10 flex gap-2.5 md:gap-4 lg:gap-3 items-center">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex -space-x-1 sm-mobile:-space-x-1.5 md:-space-x-2.5 lg:-space-x-2">
                      <div className="w-5 h-5 sm-mobile:w-6 sm-mobile:h-6 md:w-8 md:h-8 lg:w-7 lg:h-7 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full border-2 border-white shadow-sm hover:scale-110 hover:z-10 transition-all duration-300 cursor-pointer"></div>
                      <div className="w-5 h-5 sm-mobile:w-6 sm-mobile:h-6 md:w-8 md:h-8 lg:w-7 lg:h-7 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full border-2 border-white shadow-sm hover:scale-110 hover:z-10 transition-all duration-300 cursor-pointer"></div>
                      <div className="w-5 h-5 sm-mobile:w-6 sm-mobile:h-6 md:w-8 md:h-8 lg:w-7 lg:h-7 bg-gradient-to-br from-pink-400 to-pink-600 rounded-full border-2 border-white shadow-sm hover:scale-110 hover:z-10 transition-all duration-300 cursor-pointer"></div>
                      <div className="w-5 h-5 sm-mobile:w-6 sm-mobile:h-6 md:w-8 md:h-8 lg:w-7 lg:h-7 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full border-2 border-white shadow-sm hover:scale-110 hover:z-10 transition-all duration-300 cursor-pointer"></div>
                      <div className="w-5 h-5 sm-mobile:w-6 sm-mobile:h-6 md:w-8 md:h-8 lg:w-7 lg:h-7 bg-white/90 backdrop-blur-sm rounded-full border-2 border-white flex items-center justify-center shadow-sm hover:scale-110 hover:z-10 transition-all duration-300 cursor-pointer\">
                        <span className="text-gray-800 text-[7px] sm-mobile:text-[8px] md:text-[10px] lg:text-[9px] font-bold\">+500</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="featured-section md:col-span-7 flex lg:col-span-7 relative items-stretch py-4 sm-mobile:py-5 md:py-4 lg:py-12 order-2 md:order-2 lg:order-2 px-0 md:px-0 lg:pr-12 xl:pr-20">
                    ...
                    >
                      ...
                      <div className="relative flex justify-center ml-0 md:ml-4 lg:ml-16">
                        <div className="relative">
                          ...
                          {/* Featured Tag - Top Left of Image */}
                          <div className="absolute -top-6 sm-mobile:-top-5 md:-top-4 lg:-top-3 -left-2 sm-mobile:-left-8 md:-left-16 lg:-left-13 z-50">
                          ...
                          {/* Title Card - Bottom Center of Image */}
                          <div className="absolute -bottom-6 sm-mobile:-bottom-7 md:-bottom-8 lg:-bottom-10 left-1/2 -translate-x-1/2 z-50 w-full px-2 sm-mobile:px-0 flex justify-center">
                            <div
                            ...
                            >
                              <div className="relative inline-flex items-center gap-1.5 sm-mobile:gap-2 md:gap-3 bg-white/85 backdrop-blur-xl rounded-[14px] sm-mobile:rounded-[18px] md:rounded-[28px] pl-2.5 sm-mobile:pl-4 md:pl-6 lg:pl-7 pr-1 sm-mobile:pr-1.5 md:pr-2 py-2 sm-mobile:py-2.5 md:py-3 lg:py-3.5 shadow-xl border border-white/90 hover:shadow-2xl hover:-translate-y-1 transition-all overflow-hidden group/card">
                                {/* Decorative glow */}
